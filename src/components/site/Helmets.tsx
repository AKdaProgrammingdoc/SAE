        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {helmets.map((h, i) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group relative bg-[var(--gradient-card)] border border-border rounded-2xl overflow-hidden card-hover-glow"
            >
              <div className="relative aspect-[4/5] overflow-hidden bg-black">
                ...
                />
                <div className="absolute top-3 right-3 bg-primary text-primary-foreground text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-full shadow-lg">
                  {h.price}
                </div>
